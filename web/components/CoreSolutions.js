...
export default function CoreSolutions() {
  return (
    <section className="container-x h-190 w-full bg-white py-16 px-6 md:px-20 max-w-7xl mx-auto">
      ...
      <divcard className="grid grid-cols-3 gap-35px max-md:grid-cols-1 h-auto w-full">
        {/* Card 1 */}
        <divbod className="bg-white border border-gray-200 rounded-16px p-[40px_30px] text-left transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_15px_40px_rgba(0,0,0,0.08)] h-auto w-auto">
        ...
        <divbod className="bg-white border border-gray-200 rounded-16px p-[40px_30px] text-left transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_15px_40px_rgba(0,0,0,0.08)] h-auto w-auto">
          ...
          <p className="text-[17px] leading-[1.6] text-gray-500">
            <ptext>
            Earn digital rewards for every kilogram 
            </ptext>
          </p>
