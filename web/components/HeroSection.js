        ...
        <div className="flex flex-col-reverse lg:flex-row items-center gap-12">
          ...
          <div className="w-full lg:w-1/2 flex justify-center relative">
            <div className="relative w-full max">
              ...
              {/* Eco Impact Card */}
              <ecoborder className="absolute -bottom-6 -left-5 bg-white shadow-lg px-4 py-3 rounded-xl flex items-center gap-3 w-48 h-15">
                <leafborder className="bg-green-200 p-2 rounded-full">
