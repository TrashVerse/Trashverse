    ...
    <section7>
      ...
      <Navbar />
        ...
        <ulpo className="list-disc pl-6 space-y-3">
            ...
            <p>
            Waste materials traded, credits earned and payout details.
            </p>
            </li>
                <li>
            <strong>
        ...
        <p className="mb-4">
            We implement technical and organizational measures, including encryption and secure servers, to protect your personal data.
        </p>
        <h2 className="text-xl font-semibold mt-8 mb-4">
            5. Your Rights (NDPA Compliance)
        </h2>
        <p className="mb-4">
        ...
        <p> We may update this Privacy Policy periodically. Significant changes will be communicated through our website or email.</p>
